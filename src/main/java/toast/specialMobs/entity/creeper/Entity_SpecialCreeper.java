...
public class Entity_SpecialCreeper extends EntityCreeper implements ISpecialMob {
    ...
    public void writeEntityToNBT(NBTTagCompound tag) {
        ...
        tag.setBoolean("DryExplode", this.canNotExplodeWhenWet());
        tag.setBoolean("BurningExplode", this.explodesWhenBurning());
        tag.setBoolean("ShotExplode", this.explodesWhenShot());
