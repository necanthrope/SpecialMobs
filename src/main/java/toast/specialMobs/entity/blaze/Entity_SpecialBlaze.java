...
public class Entity_SpecialBlaze extends EntityBlaze implements ISpecialMob {
    ...
    public void writeEntityToNBT(NBTTagCompound tag) {
        ...
        tag.setShort("SMFireballBurstCount", this.fireballBurstCount);
        tag.setShort("SMFireballBurstDelay", this.fireballBurstDelay);
    ...
    public void readEntityFromNBT(NBTTagCompound tag) {
        ...
        if (tag.hasKey("SMFireballBurstCount")) {
            this.fireballBurstCount = tag.getShort("SMFireballBurstCount");
        }
        if (tag.hasKey("SMFireballBurstDelay")) {
